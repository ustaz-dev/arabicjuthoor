...
SOURCES = [
    ...
    ("jassem-2013-celestial", "https://web.archive.org/web/20190828030058id_/http://ijee.org:80/yahoo_site_admin/assets/docs/27.89114953.pdf"),
    ...
    ("jassem-2013-cognitive", "https://web.archive.org/web/20200717074241id_/http://ijee.org/yahoo_site_admin/assets/docs/7.271143130.pdf"),
    ...
    ("jassem-2015-medical", "https://www.joell.in/wp-content/uploads/2015/08/Zaidan-Ali-Jassem.pdf"),
    ("jassem-2015-urban", "https://journal.uniku.ac.id/index.php/ERJEE/article/download/204/161"),
    ("jassem-2016-definite", "https://web.archive.org/web/20200320043645id_/https://ijellh.com/OJS/index.php/OJS/article/download/1489/8673"),
...
FAILED_SOURCES = [
    ...
    ("jassem-2013-celestial-ojs-file", "https://ijee.org/ijee/article/download/1266/1259/3875",
     "ولّد عارضُ OJS هذا المسارَ النهائيَّ للملف، لكنّه ردّ 404"),
    ("jassem-2013-celestial-legacy", "https://www.ijee.org/assets/docs/27.89114953.pdf",
     "ردّ مستودعُ IJEE الحديث 404؛ واستُبدل بلقطةِ PDF رسميّةٍ من مسارِ yahoo_site_admin القديم"),
    ("jassem-2013-cognitive-ojs", "https://ijee.org/ijee/article/download/1296/1289",
     "ردّ مسارُ OJS الجديد 404؛ وملفُّ المجلةِ القديمُ ظاهرٌ في الفهرسِ لكنّه محذوفٌ من المستضيف"),
    ("jassem-2013-cognitive-ojs-file", "https://ijee.org/ijee/article/download/1296/1289/3967",
     "ولّد عارضُ OJS هذا المسارَ النهائيَّ للملف، لكنّه ردّ 404"),
    ...
    ("jassem-2016-definite-ojs", "https://ijellh.com/OJS/index.php/OJS/article/download/1489/8673",
     "ردّ مسارُ OJS الحالي 404؛ واستُبدل بلقطةِ PDF رسميّةٍ صالحةٍ مؤرَّخةٍ في 2020-03-20"),
    ("jassem-2016-campbell-legacy", "https://ijellh.com/wp-content/uploads/2016/06/64.-Zaidan-Ali-Jassem-paper-final.pdf",
     "ردّ مستودعُ IJELLH القديم 404؛ ويورده فهرسُ المؤلّف لمراجعةِ كامبل لا لبحثِ أدواتِ التعريف"),
    ...
    ("jassem-2015-medical-catalog", "https://www.joell.in/vol-ii-issue-i-2015/",
     "أثبتَ الفهرسُ البحثَ وصفحاتِه، لكن رابطَ التنزيلِ يحيلُ إلى صورةِ أيقونة؛ واستُبدل بمرفقِ PDF الرسميِّ الظاهرِ في واجهةِ ووردبريس"),
    ...
    ("jassem-2016-vocabulary-learning-teaching-pinba-x-malang", "https://repository.uin-malang.ac.id/4808/1/02%20Proseding%20IMLA%202016_Halimi%20Zuhdy.pdf",
     "يُثبتُ فهرسُ المؤتمر في الملفِّ عنوانَ بحثِ جاسم وصفحاتِه 50–70، لكنّ التنزيلَ ذو 28 صفحةً لا يحملُ متنَه؛ إنّما يحملُ مقدّماتِ المؤتمر ثمّ بحثَ حليمي زهدي «التناص ومقاربة النص» ابتداءً من الصفحةِ المطبوعةِ 1305"),
]
