...
# اللواحقُ التي هي تصريفٌ يقينيٌّ في صيغِ الاستشهادِ الجرمانيّةِ فلا تكونُ
# جذريّةً (نوناتُ المصادرِ والمطاوعةِ وسيناتُ الإعرابِ ونهاياتُ الصرف)؛
# أمّا اللواحقُ الاسميّةُ (um وing وnes...) فمطابقتُها قد تكونُ عارضةً
# تصادفُ حروفَ الجذرِ نفسِها (درسُ ققم) فلا تدخلُ اليقين. مسبارُ D الثاني
# عشرَ (ushulōn): كانت قائمةُ اليقينِ نسخةً يدويّةً جزئيّةً ففاتَتها -on
# المعروفةُ للجدولِ نفسِه؛ فصارَ الوسمُ هنا بجانبِ الجدولِ لا نسخةً عنه.
CERTAIN_ENDINGS = frozenset({
    "ianne", "enne", "ian", "jan", "nan", "an", "on", "s", "es", "að", "aþ",
})
