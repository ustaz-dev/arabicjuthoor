...
# 76 حتى ملحق 2026-08-17 المأذون (خمسة صفوف يونانية BR-GREC-02..06)،
# انظر 05-audits/2026-08-17-author-ok-123-rulings.md
if len(network_ids) != 81:
    fails.append(f"shift network: expected 81 table rows, found {len(network_ids)}")
...
if "الشبكةُ التشغيليّةُ الآن 81 قيدًا" not in network:
    fails.append("shift network: operative 81-entry status is missing")
