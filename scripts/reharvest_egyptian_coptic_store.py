...
AED_SELECTIONS: dict[int, str] = {
    ...
    915: "132820", 916: "132820", 917: "132820", 918: "132820",
    919: "132820", 920: "132820", 921: "132820", # spr, rib
    922: "69590", 923: "69590", 924: "69590", 925: "69590",
    926: "69590", 927: "69590",               # mn, remain
    942: "87560", 943: "87560", 944: "87560", 945: "87560",
    946: "87560", 947: "87560", 948: "87560", # nḫt, be strong
    956: "164320",                             # km, black
    985: "69590", 986: "69590", 987: "69590", 988: "69590",
    989: "69590",                              # mn, remain
    990: "46710",                              # wnm, eat
    991: "46820",                              # wnm.w, devourer
    1011: "136220",                            # sn, associate with
    1018: "90260", 1019: "90260", 1020: "90260", # nṯr, god
    1048: "172700", 1049: "172700", 1050: "172700", # tr, time; season
}
...
MANUAL_NEW: dict[tuple[int, str], tuple[str, str]] = {
    ...
    (915, "سبر"): (
        "NUCLEUS-TRACE",
        "مدار الهيئة التشريحية: `rib; ribs` عظم دقيق ممتد يتصل بالعمود "
        "الفقري، وحدث `سبر` المجمّد «الامتداد الدقيق مع الاتصال بشيء» يصف "
        "هذه الهيئة نفسها.",
    ),
    (916, "سبر"): (
        "NUCLEUS-TRACE",
    ...
    (1048, "تور"): (
        "ROOT-TRACE",
        "مدار الدورة الزمنية: `time; season` وقت محدود يعود كلما تم دورُه، "
        "وحدث `تور` المجمّد رجوع الشيء إلى ما فارقه وتردده عليه؛ فالموسم عودة "
        "زمنية متكررة.",
    ),
    (1049, "تور"): (
        "ROOT-TRACE",
