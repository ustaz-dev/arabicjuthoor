...
h = h.replace('200 entries', '297 entries').replace('200 worked pairs', '297 worked pairs')
h = h.replace('of 200 entries', 'of 297 entries').replace('مِن 200 مَدخَل', 'مِن 297 مَدخَل')
h = h.replace('result-count">200<', 'result-count">297<')
