...
h = h.replace('200 entries', '273 entries').replace('200 worked pairs', '273 worked pairs')
h = h.replace('of 200 entries', 'of 273 entries').replace('مِن 200 مَدخَل', 'مِن 273 مَدخَل')
h = h.replace('result-count">200<', 'result-count">273<')
