...
h = h.replace('200 entries', '294 entries').replace('200 worked pairs', '294 worked pairs')
h = h.replace('of 200 entries', 'of 294 entries').replace('مِن 200 مَدخَل', 'مِن 294 مَدخَل')
h = h.replace('result-count">200<', 'result-count">294<')
