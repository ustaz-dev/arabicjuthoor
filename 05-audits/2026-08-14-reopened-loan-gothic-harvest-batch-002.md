# حصاد القرض المعاد فتحه: القوطية/Gothic، الدفعة 002 (2026-08-14)
...
- مر على القاموس: 43 من 43 بطاقة.
- تعينت مدخلة موافقة للسياق: 42 بطاقة.
- بقي سياق المدخلة غير متعين: 1 بطاقة.
- سُجل اختلاف بين عمود الباحث ومعنى القاموس الأوسع أو المختلف: 2 بطاقة.

## الحصيلة

- فُحص: 43 بطاقة.
- كُتب: 43 بطاقة ناسخة ملحقة، من غير محو البطاقة التاريخية.
...
- بقي OPEN-CANDIDATE: 43 بطاقة.
- سبب الفتح: 1 من البطاقات، لم تتعين مدخلة من قاموس الفرع توافق سياق الصف.
- سبب الفتح: 26 من البطاقات، اكتمل الصوت والحدث ولم يقنع مدار يدوي.
