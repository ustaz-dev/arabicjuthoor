...
Update [`Juthoor-ArabicGenome-LV1/scripts/ingest_muajam.py`](../../Juthoor-Linguistic-Genealogy/Juthoor-ArabicGenome-LV1/scripts/ingest_muajam.py):
...
- [`Juthoor-Linguistic-Genealogy/outputs/audits/14_root_delta.json`](../../Juthoor-Linguistic-Genealogy/outputs/audits/14_root_delta.json) — full diff payload
- [`Juthoor-Linguistic-Genealogy/outputs/audits/14_root_delta.md`](../../Juthoor-Linguistic-Genealogy/outputs/audits/14_root_delta.md) — table of all 380 mangled and 757 master-only roots
- [`Juthoor-Linguistic-Genealogy/scripts/audit_14_root_delta.py`](../../Juthoor-Linguistic-Genealogy/scripts/audit_14_root_delta.py) — reproducer
