# حصاد القرض المعاد فتحه: الإيرلندية القديمة/Old Irish، الدفعة 002 (2026-08-14)
...
- تعينت مدخلة موافقة للسياق: 124 بطاقة.
- بقي سياق المدخلة غير متعين: 26 بطاقة.
- سُجل اختلاف بين عمود الباحث ومعنى القاموس الأوسع أو المختلف: 61 بطاقة.
...
- سبب الفتح: 26 من البطاقات، لم تتعين مدخلة من قاموس الفرع توافق سياق الصف.
...
- سبب الفتح: 3 من البطاقات، لم تولد المروحة مرشحًا من الهيكل.

## أبرز الأزواج الداخلة

1. `corann،` ↔ `قرن` (ROOT-TRACE)
2. `corann،` ↔ `قرن` (ROOT-TRACE)
