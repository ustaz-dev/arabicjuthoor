...
| `𐌷𐌰𐍂𐌳𐌿𐍃` | `*kert` | Proto-Indo-European | k-r-t | hard | **قرث** | مباشر 3: hard |
| `𐍅𐌰𐌹𐍂𐌸𐌰𐌽` | `*wert` | Proto-Indo-European | w-r-t | to become; to happen, to come to pass | **ورط** | مباشر 3: become |
| `𐌼𐌹𐍄𐌰𐌸𐍃` | `*med` | Proto-Indo-European | m-d | measure | **مد** | مباشر 3: measure |
...
| `𐌱𐍉𐍄𐌰` | `*bōtō` | Proto-Germanic | b-t | benefit, use | **بث** | مباشر 3: use |
| `𐍃𐌰𐌻𐌹𐌸𐍅𐍉𐍃` | `*saliþwō` | Proto-Germanic | s-l-w | lodgings, guest room | **صلو** | مباشر 3: room |
| `𐌻𐌰𐌹𐌺𐍃` | `*laikaz` | Proto-Germanic | l-k-z | dance | **رقص** | مباشر 3: dance |
| `𐌼𐌴𐌻` | `*mēlą` | Proto-Germanic | m-l | time; a point in time, especially an appointed or fixed time. | **مر** | مباشر 3: time |
| `𐍃𐌻𐌰𐍅𐌰𐌽` | `*slūm` | Proto-Germanic | s-l-m | to keep quiet, be still | **سلم** | مباشر 3: keep |
| `𐍂𐌹𐌲𐌽` | `*regną` | Proto-Germanic | r-g-n | rain (condensed water from a cloud) | **لجن** | مباشر 3: water |
| `𐍃𐌰𐌹𐍂` | `*sairą` | Proto-Germanic | s-r | pain; sorrow | **سر** | مباشر 3: pain |
| `𐍃𐌰𐌼𐌰𐌽𐌰` | `*samanai` | Proto-Germanic | s-m-n | together | **زمن** | مباشر 3: together |
| `𐌱𐌰𐌿𐍄𐌰𐌽` | `*bautaną` | Proto-Germanic | b-t-n | to beat, strike | **بطن** | مباشر 3: strike |
| `𐍅𐌿𐌻𐍆𐍃` | `*wĺ̥kʷos` | Proto-Indo-European | w-kʷ-s | wolf (animal) | **وقز** | قرينة 1: animal |
| `𐍄𐍂𐌹𐌿` | `*dóru` | Proto-Indo-European | d-r | piece of wood | **ذر** | قرينة 1: piece |
...
| `𐌰𐍂𐍈𐌰𐌶𐌽𐌰` | `*arhwō` | Proto-Germanic | r-h-w | missile (air-based weapon), arrow, dart | **رخو** | قرينة 1: air |
| `𐍃𐌰𐌹𐍅𐌰𐌻𐌰` | `*saiwalō` | Proto-Germanic | s-w-l | soul | **زول** | قرينة 1: soul |
| `𐌰𐌵𐌹𐌶𐌹` | `*akwisī` | Proto-Germanic | k-w-s | axe (tool for felling trees) | **كوس** | قرينة 1: tool |
| `𐍂𐌰𐌿𐍃` | `*rauzą` | Proto-Germanic | r-z | cane (plant with a simple and flexible stem, or the stem thereof); cane (stem of such a pl | **رز** | قرينة 1: plant |
| `𐌰𐌽𐌳𐌰𐌷𐌰𐌹𐍄` | `*haitą` | Proto-Germanic | h-t | confession, profession | **خت** | قرينة 1: profession |
| `𐍆𐌰𐌿𐍃` | `*fawaz` | Proto-Germanic | f-w-z | few, not many | **بوز** | قرينة 1: many |
| `𐍂𐌰𐌲𐌹𐌽` | `*raginą` | Proto-Germanic | r-g-n | law, decree, ordinance; opinion, judgment, advice, counsel | **لجن** | قرينة 1: law |
| `𐍄𐌹𐌻` | `*tilą` | Proto-Germanic | t-l | something fitting or suitable (attested only as an accusative singular; plausibly not a no | **طر** | قرينة 1: only |
| `𐌳𐌰𐌿𐌸𐌾𐌰𐌽` | `*daudijaną` | Proto-Germanic | d-j-n | to kill, murder; to put to death, execute | **دين** | قرينة 1: death |
| `𐍂𐌰𐌸𐌾𐍉` | `*raþjǭ` | Proto-Germanic | r-j | account, number | **لي** | قرينة 1: number |
| `𐌹𐌽𐍅𐌴𐌹𐍄𐌰𐌽` | `*wītaną` | Proto-Germanic | w-t-n | to worship; to salute | **وثن** | قرينة 1: worship |
| `𐍃𐌿𐌼𐌰𐌽` | `*suman` | Proto-Germanic | s-m-n | once, at some point (in the past); in part | **زمن** | قرينة 1: point |
