...
The cross-linguistic work in this project found a **family-distance gradient**, the closer a language is to Arabic, the more of the sound-meaning logic it preserves:

| Test | Top-tier hit-rate | Verdict ladder used |
|------|------------------:|---------------------|
...
Each entry below is read at the **gesture-floor only**, never as an Arabic root. The form (hanzi + pinyin) and gloss are standard sinology; the charge-reading is the project's interpretive layer.

### MOTHER · the **م / m** gesture (lips gathering)
- 妈 *mā* and the older 母 *mǔ* both open on **م**, the lips close and gather, the nursing infant's first bilabial. The framework reads م as *gathering, the gathered source*, and 母 is a **pictograph** (象形) of a kneeling woman with two dots for the breasts: the sign drawing the nursing body while the mouth makes the gathering م. This is the same م that builds Arabic أُمّ and the word for *mother* across 1,072 languages (Murdock 1959).

### BIG · the open **ا / a** gesture (the breath standing open)
- 大 *dà* is said with the mouth thrown wide on the open a-vowel, and the character draws **a person standing with arms outstretched**. The framework reads ا as *extension, the breath standing open*, the mouth opening wide for the wide thing.

### YOU / person-deixis · the **ن / n** gesture (inner resonance)
- 你 *nǐ* "you" carries the **ن** of person-deixis, the nasal that marks a person-referent. The framework reads ن as *inner resonance emitted outward*: the voice from within, directed at the addressed self. (Honest note below on where the first-person ن does and does not surface.)

### WATER / flow · the streaming sibilant, and the drawn stream
...
Chinese offers something the sound-only tests cannot: a second, independent confirmation of the deep principle. **Chinese characters began as pictures.** 水 *shuǐ* was a drawn stream; 山 *shān* "mountain" was three peaks; 日 *rì* "sun" was a disc with a central dot; 目 *mù* "eye" was a drawn eye; 心 *xīn* "heart" was a drawn heart; 火 *huǒ* "fire" was rising flames. The meaning was carried **in the shape of the sign itself** (the 象形 *xiàngxíng*, "form-imitating," category, well-established sinology, not a novel claim).

This is the same principle as the Juthoor framework, reached by a **different road**:

- **Arabic** encodes meaning in the **articulatory gesture**, the shape the mouth makes (م = lips gathering = the gathered mother/mass).
- **Chinese** encodes meaning in the **visual gesture**, the shape the hand draws (水 = the drawn flow of water).

Two roads, one destination: **meaning living in the form of the sign, not arbitrarily assigned to it.** Saussure's "arbitrariness of the sign" is the claim both traditions quietly refute, Arabic through the mouth, Chinese through the eye. For the pictograph entries (目, 山, 日, 心, 火, and the written 母) the floor reading leans on this visual road; for the pure baby-words (妈, 大, 你) it leans on the articulatory one.
...
- Jakobson, Roman (1960). "Why 'Mama' and 'Papa'?", the nursing-gesture origin of the m.
- Saussure, Ferdinand de (1916). *Cours de linguistique générale.*, the arbitrariness thesis this layer engages.

## Cross-links

- The universal floor, stated in full: [`universal-baby-words.md`](universal-baby-words.md).
- The genetic ladder for comparison: [`tier-a-hebrew-cognates.md`](tier-a-hebrew-cognates.md), [`tier-a-afro-asiatic-cognates.md`](tier-a-afro-asiatic-cognates.md), [`sanskrit-indo-iranian-echoes.md`](sanskrit-indo-iranian-echoes.md).
- The fixed letter-charges: [`../03-scholar-extracts/consensus-letter-charges.md`](../03-scholar-extracts/consensus-letter-charges.md).
