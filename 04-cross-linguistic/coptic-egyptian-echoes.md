...
```mermaid
graph TD
    A[Proto-Afro-Asiatic Root: *l-s-n*] --> B[Hieroglyphic: ns]
    A --> C[Spoken Vernacular: kept l-s]
    B -->|Written Omission of Liquid 'l'| D[Visual Mismatch with Arabic]
    C -->|Preserved in Spoken Coptic| E[Coptic: las / ⲗⲁⲥ]
    E -->|Aligned with| F[Arabic: lisān / لِسَان]
```
