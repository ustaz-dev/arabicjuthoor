...
> **الحالة: أُعيدَ تَدريجُها تَحتَ انضِباطِ التَّدَرُّج (2026-05-24).** السنسكريتيّةُ هندوأوربيّة — أَقصى طَرَفِ الأُسرة. إيجادُ جِنَاساتٍ قَويّةٍ هُنا سَيَكونُ وَهمًا، لِذا **صِفر تامّ/قَويّ**: كُلُّ مُحاذاةٍ تَلاقٍ أو نَظيرٌ بَعيدٌ أو كَلِمةٌ جائلةٌ أو مُصادَفة. هذه ليسَت روزنامةَ جِنَاس بَل مِرساةُ التَّدَرُّجِ القُصوى. الدَّرَجاتُ في [`data/sanskrit-cognates.json`](data/sanskrit-cognates.json).
