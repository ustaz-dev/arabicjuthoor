...
## كَيف يَعمَل «الصَّدى» بَين لُغَتَين

جَرِّد الكَلِمةَ مِن حَركاتها واترُك صَوامِتَها. كَلام بِالعَرَبيّة تَصير K-L-M. *clāmāre* بِاللاتينيّة K-L-M. *claim* بِالإنجليزيّة K-L-M. نَفس الحُروف، نَفس التَّرتيب، نَفس المَعنى — *صَوتٌ مَمدودٌ تَحت قَيد*. هذا هو الصَّدى.

هذه الصَّفحةُ تَجمَع أَزواجًا كَهذه، حَيث:

- الصَّوامتُ تَتَطابَق (مَع السَّماح بِبَعض الإبدالات المَعروفة كَ K↔Q أَو F↔P)،
- المَعاني تَتَطابَق (لا تَشابُهٌ صَوتيٌّ سَطحيٌّ فَقَط)،
- الكَلِمةُ الأَجنبيّةُ ما زالَت مَألوفةً لِلقارئ المُعاصِر،
- وتَظهَر شَهادةٌ مِن السامِيّة و مِن الهندوأوربيّة مَعًا.

حَين تَصِحّ كُلُّ هذه الأَربعة، نَعُدُّ الزَّوجَ مُؤَكَّدًا. حَين لا تَصِحّ، يَبقى عَلى قائمة المُلاحَظة.
...
## الأَربعةُ شُروطٍ التي يَجِب أَن يَجتازَها أَيُّ زَوجٍ مُؤَكَّد

لِيَدخُل الزَّوجُ القائمةَ المُؤَكَّدة، الأَربعةُ تَجتَمِع:

١. **الصَّوامتُ تَتَطابَق.** ليسَ تَطابُقًا حَرفيًّا — مَع السَّماح بِإبدالاتٍ مُوَثَّقة (الـ ق العَرَبيّة قَد تَصير K، الـ ف قَد تَصير P، الـ ج قَد تَصير G أَو K، الـ ط قَد تَلين إلى T). هذه الإبدالاتُ مِن قَوانين خشيم التِّسعة، إضافةً إلى قانونٍ عاشِر (ط↔T) ظَهَرَ مِن تَدقيقنا عَلى بَيانات حَقيقيّة — [انظُر التَّدقيق](../05-audits/2026-05-21-khshim-laws-audit-ar.md).
٢. **المَعنى يَتَطابَق في البِذرة.** لا في القاموس السَّطحيّ — في النَّواة المَفهوميّة. كَلام ليسَت مُجَرَّد «نُطق»؛ هي «صَوتٌ مَمدودٌ تَحت قَيد». *Claim* تَحمِل نَفسَ النَّواة. *Stamp* لا تَحمِلها.
٣. **القارئُ المُعاصِر يَتَعَرَّف عَلى الكَلِمة الشَّريك.** اللاتينيّةُ *invidia* لَن تَنفَع أَكثَر النَّاس؛ الإنجليزيّةُ *envy* ستَنفَع. نُفَضِّل ما زالَ حَيًّا اليَوم.
